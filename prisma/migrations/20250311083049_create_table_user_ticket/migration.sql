...
-- AddForeignKey
ALTER TABLE `user_tickets` ADD CONSTRAINT `user_tickets_eventId_fkey` FOREIGN KEY (`eventId`) REFERENCES `events`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `user_tickets` ADD CONSTRAINT `user_tickets_quiz_topic_id_fkey` FOREIGN KEY (`quiz_topic_id`) REFERENCES `quiz_topics`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;
