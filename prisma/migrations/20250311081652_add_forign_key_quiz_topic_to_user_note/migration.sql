...
-- AlterTable
ALTER TABLE `user_notes` ADD COLUMN `quiz_topic_id` INTEGER NULL;

-- AddForeignKey
ALTER TABLE `user_notes` ADD CONSTRAINT `user_notes_quiz_topic_id_fkey` FOREIGN KEY (`quiz_topic_id`) REFERENCES `quiz_topics`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;
